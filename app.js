...
(function() {
  var addChainedAttributeAccessor, attr, draw,
    __slice = [].slice;
  ...
  L.ParaText = L.Class.extend({
    ...
    makeRelations: function() {
      ...
      if (this.options.field_category !== '') {
        ...
        return console.log("define the field that has relations first");
      }
    },
    ...
    show_contexts: function(d, e) {
      ...
      if (this._d3obj) {
        _d3obj = this._d3obj;
        d3.selectAll(document.getElementsByClassName("context span")).data([]).exit().remove();
      } else {
        _d3obj = d3.select(_domEl).selectAll("span").data(featureData).enter();
      }
      this._d3obj = _d3obj;
      return _d3obj.append("span").text((function(_this) {
        return function(d, i) {
          return d;
        };
      })(this)).attr("class", "context span");
    },
  ...
  for (attr in this.options) {
    addChainedAttributeAccessor(this, 'options', attr);
  }
